...
<body>
    ...
    <div class="outer">
        ...
        <div>
            <label>Mobile no(The number provided to signup)</label><br>
            <input type="tel" class="form-control" id="t4" minlength="10" maxlength="10" name="mobile" readonly>
        </div><br>
        <div>
...
?>
  ...
  var Details = JSON.parse(localStorage.getItem('Details'));
    ...
    document.getElementById('t4').value = mobile;
